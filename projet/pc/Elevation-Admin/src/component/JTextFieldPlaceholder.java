...
public class JTextFieldPlaceholder extends JTextField {
	 ...
	 */
	public JTextFieldPlaceholder(int columns, String placeholder) {
		super(columns);
	...
	private void addListeners() {
		JTextFieldPlaceholder textField = this;
		textField.addKeyListener(new KeyAdapter() {
			@Override
			public void keyTyped(KeyEvent keyEvent) {
				if (keyEvent.getKeyChar() != KeyEvent.VK_BACK_SPACE && keyEvent.getKeyChar() != KeyEvent.VK_DELETE) {
